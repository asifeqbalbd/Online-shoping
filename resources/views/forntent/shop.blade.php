            ...
            <div class="container">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="all">
                        <ul class="row">
                            @foreach($product_shop as $key => $ps)
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="product-icon flex-style">
                                                <ul>
                                                    ...
                                                    <li><a href="{{ route('SingleWishlist',$ps->id) }}"><i class="fa fa-heart"></i></a></li>
                                                    <li><a href="{{ route('SingleCart',$ps->id) }}"><i class="fa fa-shopping-bag"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-body d-flex">
                                                ...
                                                <div class="product-single-content w-50">
                                                    ...
                                                    <ul class="input-style">
                                                        <li><a href="{{ route('SingleCart',$ps->id) }}">Add to Cart</a></li>
                                                    </ul>
                                                    <ul class="cetagory">
                                                        <li>Categories:</li>
                                                ...
                                                <div class="product-img">
                                                    ...
                                                    <div class="product-icon flex-style">
                                                        <ul>
                                                            ...
                                                            <li><a href="{{ route('SingleWishlist',$items->id) }}"><i class="fa fa-heart"></i></a></li>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body d-flex">
                                                        ...
                                                        <div class="product-single-content w-50">
                                                            ...
                                                            <ul class="input-style">
                                                                <li><a href="{{ route('SingleCart',$items->id) }}">Add to Cart</a></li>
                                                            </ul>
                                                            <ul class="cetagory">
                                                                <li>Categories:</li>
