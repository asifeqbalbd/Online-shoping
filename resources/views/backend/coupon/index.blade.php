                        ...
                        <div class="card-box">
                            ...
                            <form action="{{ route('couponadd') }}" method="post" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('coupon_code') }}" class="form-control @error('coupon_code') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('coupon_discount') }}" class="form-control @error('coupon_discount') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ old('coupon_validity') }}" class="form-control @error('coupon_validity') is-invalid @enderror"
