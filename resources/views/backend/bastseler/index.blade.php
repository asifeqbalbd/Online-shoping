@extends('backend/master')
    @section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card-box">
                <h4 class="header-title mb-4 text-center text-danger">Add BastSeler Overview</h4>
                <div class="container">
                    <div class="row">
                    <div class="col-8 offset-2">
                        ...
                        <div class="card-header" style="">
                            ...
                            @if(session('slug'))
                                    ...
                                    <hr>
                            @endif
                                <form action="{{ route('BestSelaradd') }}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="image_gallery" name="image_gallery[]" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                                        @error('image_gallery')
                                            <div class="alert alert-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
